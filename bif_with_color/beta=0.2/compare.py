...
for filename in ['gamma = 0.1/gamma_0.1.dat', 'gamma = 0.1/stable1.dat', 'gamma = 0.1/stable2.dat'] :
...
data = np.load('gamma = 0.1/mesh_cycles.npz')
...
ax[0].set_title('$\gamma$=0.1', fontsize=14)
