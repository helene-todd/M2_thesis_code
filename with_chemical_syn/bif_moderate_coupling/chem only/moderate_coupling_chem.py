...
for I in np.linspace(1, 2, 101) :
    ...
    if isinstance(intersection_points, geometry.multipoint.MultiPoint) and len(intersection_points) > 2 :
        ...
        if (len(intersection_points) == 3 and intersection_points[0].x > 0.01) or len(intersection_points) == 5:
            if u1(intersection_points[int(len(intersection_points)/2)-1].x, intersection_points[int(len(intersection_points)/2)-1].y, kappa, alpha) < 1 \
             and u2(intersection_points[int(len(intersection_points)/2)-1].x, intersection_points[int(len(intersection_points)/2)-1].y, kappa, alpha) < 1 :
        ...
        if len(intersection_points) == 4 :
            ...
            if len(values) == 3 :
                if u1(intersection_points[0].x, intersection_points[0].y, kappa, alpha) < 1 \
                 and u2(intersection_points[0].x, intersection_points[0].y, kappa, alpha) < 1 :
                    values_I_forks.append(round(I, 7))
