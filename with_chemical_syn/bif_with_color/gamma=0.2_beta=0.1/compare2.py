...
for filename in ['kappa=0.05_alpha=2/kappa=0.05_alpha=2.dat', 'kappa=0.05_alpha=2/stable1.dat', 'kappa=0.05_alpha=2/stable2.dat'] :
...
data = np.load('kappa=0.05_alpha=2/mesh_cycles.npz')
...
ax[0,0].set_title('$\kappa$=0.05, $\\alpha$=2', fontsize=13)
ax[0,0].set_ylabel('Phase Difference $\phi$', size=12)

ax[0,0].pcolormesh(data['I'], data['phi'], data['cycles'], cmap='Spectral', shading='smooth', edgecolors=None, norm = colors.SymLogNorm(linthresh=0.03, linscale=0.03, vmin=min_val, vmax=max_val, base=10))
...
for filename in ['kappa=0.2_alpha=2/kappa=0.2_alpha=2.dat', 'kappa=0.2_alpha=2/stable1.dat', 'kappa=0.2_alpha=2/stable2.dat']:
    with open(filename, newline='') as file:
        datareader = csv.reader(file, delimiter=' ')
...
data = np.load('kappa=0.2_alpha=2/mesh_cycles.npz')
...
ax[0,1].set_title('$\kappa$=0.2, $\\alpha$=2', fontsize=13)
ax[0,1].pcolormesh(data['I'], data['phi'], data['cycles'], cmap='Spectral', shading='smooth', edgecolors=None, norm = colors.SymLogNorm(linthresh=0.03, linscale=0.03, vmin=min_val, vmax=max_val, base=10))
...
for filename in ['kappa=0.3_alpha=2/kappa=0.3_alpha=2.dat', 'kappa=0.3_alpha=2/stable1.dat', 'kappa=0.3_alpha=2/stable2.dat']:
    with open(filename, newline='') as file:
        datareader = csv.reader(file, delimiter=' ')
...
data = np.load('kappa=0.3_alpha=2/mesh_cycles.npz')
...
ax[0,2].set_title('$\kappa$=0.3, $\\alpha$=2', fontsize=13)
ax[0,2].pcolormesh(data['I'], data['phi'], data['cycles'], cmap='Spectral', shading='smooth', edgecolors=None, norm = colors.SymLogNorm(linthresh=0.03, linscale=0.03, vmin=min_val, vmax=max_val, base=10))
...
for filename in ['kappa=0.05_alpha=4/kappa=0.05_alpha=4.dat', 'kappa=0.05_alpha=4/stable1.dat', 'kappa=0.05_alpha=4/stable2.dat'] :
    with open(filename, newline='') as file:
        datareader = csv.reader(file, delimiter=' ')
...
data = np.load('kappa=0.05_alpha=4/mesh_cycles.npz')
...
ax[1,0].set_title('$\kappa$=0.05, $\\alpha$=4', fontsize=13)
ax[1,0].set_xlabel('Current $I$', size=12)
ax[1,0].set_ylabel('Phase Difference $\phi$', size=12)

ax[1,0].pcolormesh(data['I'], data['phi'], data['cycles'], cmap='Spectral', shading='smooth', edgecolors=None, norm = colors.SymLogNorm(linthresh=0.03, linscale=0.03, vmin=min_val, vmax=max_val, base=10))
...
for filename in ['kappa=0.2_alpha=4/kappa=0.2_alpha=4.dat', 'kappa=0.2_alpha=4/stable1.dat', 'kappa=0.2_alpha=4/stable2.dat']:
    with open(filename, newline='') as file:
        datareader = csv.reader(file, delimiter=' ')
...
data = np.load('kappa=0.2_alpha=4/mesh_cycles.npz')
...
ax[1,1].set_title('$\kappa$=0.2, $\\alpha$=4', fontsize=13)
ax[1,1].set_xlabel('Current $I$', size=12)
ax[1,1].pcolormesh(data['I'], data['phi'], data['cycles'], cmap='Spectral', shading='smooth', edgecolors=None, norm = colors.SymLogNorm(linthresh=0.03, linscale=0.03, vmin=min_val, vmax=max_val, base=10))
...
for filename in ['kappa=0.3_alpha=4/kappa=0.3_alpha=4.dat', 'kappa=0.3_alpha=4/stable1.dat', 'kappa=0.3_alpha=4/stable2.dat']:
    with open(filename, newline='') as file:
        datareader = csv.reader(file, delimiter=' ')
...
data = np.load('kappa=0.3_alpha=4/mesh_cycles.npz')
...
ax[1,2].set_title('$\kappa$=0.3, $\\alpha$=4', fontsize=13)
ax[1,2].set_xlabel('Current $I$', size=12)

im = ax[1,2].pcolormesh(data['I'], data['phi'], data['cycles'], cmap='Spectral', shading='smooth', edgecolors=None, norm = colors.SymLogNorm(linthresh=0.03, linscale=0.03, vmin=min_val, vmax=max_val, base=10))
...
plt.suptitle('Bifurcation diagrams for moderately coupled neurons, $\gamma=0.2, \\beta=0.1$, with convergence speed', size=18)
fig.tight_layout()
...
cbar.set_label('Number of cycles to converge towards synchrony', labelpad=20, fontsize=15)
