...
if len(args.mesh) > 0 :
    ...
    plt.pcolormesh(data['I'], data['phi'], data['cycles'], cmap='Spectral', shading='smooth', edgecolors=None, vmin=min_val, vmax=max_val)
    plt.colorbar()
...
plt.title('Bifurcation diagram for two coupled neurons', fontsize=11)
