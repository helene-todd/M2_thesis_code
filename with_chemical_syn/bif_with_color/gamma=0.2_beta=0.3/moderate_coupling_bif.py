...
if not os.path.exists(f'gamma={gamma}_alpha={alpha}.dat'):
    os.mknod(f'kappa={kappa}_alpha={alpha}.dat')
...
f = open(f'kappa={kappa}_alpha={alpha}.dat', 'w')
...
for I in np.linspace(1, 2, 201) : #201
    print('I = ', I)
