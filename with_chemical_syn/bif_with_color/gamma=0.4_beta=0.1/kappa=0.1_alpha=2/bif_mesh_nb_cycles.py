...
def theo_u1(phi, Tm1, gamma, beta, kappa, alpha, I) :
    T_spike = fsolve(if_eq, 1, args=(phi, Tm1, gamma, beta, kappa, alpha, I))
...
nb_values = 201
currents = np.linspace(1, 2, 201) # currents I, 201
...
for I in currents :
    ...
    for k in range(len(T)):
        ...
        if continuer == True :
            ...
            # Had to remove "theo_u1(phi[k], T[k], gamma, beta, kappa, alpha, I) + gamma*beta >= 1 or "
            # because was causing problems, likely related to fsolve.
            elif theo_u2(phi[k], T[k], gamma, beta, kappa, alpha, I) + gamma*beta >= 1 :
                if phi[k] <= 0.5 :
                ...
                #print('phi_curr ', phi[k])
                #print('phi_nxt ', phi_nxt)
