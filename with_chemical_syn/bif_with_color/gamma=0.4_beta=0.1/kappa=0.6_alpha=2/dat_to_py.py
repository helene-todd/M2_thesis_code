...
if len(args.mesh) > 0 :
    ...
    cbar.set_label('Number of cycles to converge towards synchrony', labelpad=20, fontsize=10)
...
plt.title('Bifurcation diagram for two coupled neurons, $\gamma=0.4, \\beta=0.1, \kappa=0.1, \\alpha=2$', fontsize=11)
...
plt.legend(by_label.values(), by_label.keys(), loc='upper left', bbox_to_anchor=(0, 0.95))
